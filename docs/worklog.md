...
2026-08-25 | 首屏交互修复:完成首页开门动画期间的滚动锁定，统一禁止桌面滚轮、触控板和移动端触摸滚动，并在视频结束、加载异常、9 秒兜底、点击跳过或离开页面时恢复原滚动状态；TypeScript 检查通过，Vite 正式构建 1,769 个模块并完成 404 页面生成，当前仅本地完成、尚未提交测试环境
