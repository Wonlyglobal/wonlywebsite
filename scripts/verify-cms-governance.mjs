...
for(const token of ["GOOGLE_SA_KEY","GA4_PROPERTY_ID","createSign","oauth2.googleapis.com/token","searchconsole.googleapis.com","analyticsdata.googleapis.com","cms_record_analytics_sync"])if(!analyticsApi.includes(token))throw new Error(`Analytics API missing ${token}`);
