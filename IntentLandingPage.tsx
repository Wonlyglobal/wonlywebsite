...
const PAGES: Record<PageKey, PageData> = {
  "security-door-manufacturer": {
    ...
    related: [["Security Door Range", "/products/security-doors"], ["EN 1627 RC2 vs RC3 vs RC4 Door Classes", "/insights/en-1627-rc2-rc3-rc4-security-door-grades"], ["Lock Core vs Cylinder Comparison", "/insights/cylindrical-lock-core-vs-standard-cylinder"], ["Commercial Steel Security Doors", "/solutions/commercial-steel-security-doors"], ["Fire-Rated Security Doors", "/products/security-doors/fire-rated"]],
