export type CmsWorkspace="pages"|"inquiries"|"forms"|"media"|"posts"|"products"|"templates"|"calendar"|"seo"|"quality"|"search"|"languages"|"navigation"|"redirects"|"environments"|"versions"|"settings"|"roles"|"account";
const groups=[
  ...
  {title:"系统",items:[["environments","发布环境"],["versions","版本与发布"],["settings","站点设置"],["roles","权限角色"],["account","我的账号"]]},
] as const;
