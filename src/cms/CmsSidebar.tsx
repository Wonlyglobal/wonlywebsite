export type CmsWorkspace="pages"|"inquiries"|"forms"|"media"|"posts"|"products"|"templates"|"calendar"|"seo"|"quality"|"search"|"languages"|"navigation"|"redirects"|"environments"|"versions"|"settings"|"account";
const groups=[
  ...
  {title:"系统",items:[["environments","发布环境"],["versions","版本与发布"],["settings","站点设置"],["account","管理员账号"]]},
] as const;
