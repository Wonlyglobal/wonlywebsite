export type CmsWorkspace="pages"|"inquiries"|"forms"|"media"|"posts"|"products"|"templates"|"calendar"|"seo"|"analytics"|"quality"|"search"|"languages"|"navigation"|"redirects"|"environments"|"versions"|"settings"|"roles"|"audit"|"account";
const groups=[
  ...
  {title:"网站优化",items:[["seo","SEO 设置"],["analytics","数据看板"],["quality","页面质量"],["search","全站搜索"],["languages","多语言"],["navigation","导航菜单"],["redirects","重定向"]]},
