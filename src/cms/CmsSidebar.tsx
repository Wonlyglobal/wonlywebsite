export type CmsWorkspace="pages"|"inquiries"|"forms"|"media"|"posts"|"products"|"templates"|"calendar"|"seo"|"analytics"|"recommendations"|"quality"|"search"|"languages"|"navigation"|"redirects"|"environments"|"integrations"|"versions"|"settings"|"roles"|"audit"|"account";
const groups=[
  ...
  {title:"系统",items:[["environments","发布环境"],["integrations","插件与接口"],["versions","版本与发布"],["settings","站点设置"],["roles","权限角色"],["audit","审计日志"],["account","我的账号"]]},
] as const;
