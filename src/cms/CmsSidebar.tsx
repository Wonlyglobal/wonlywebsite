export type CmsWorkspace="pages"|"inquiries"|"media"|"posts"|"products"|"calendar"|"seo"|"languages"|"navigation"|"redirects"|"versions"|"settings"|"account";
const groups=[
  {title:"内容",items:[["pages","页面编辑"],["inquiries","询盘管理"],["media","媒体库"],["products","产品管理"]]},
