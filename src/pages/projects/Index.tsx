...
const COPY: Partial<Record<Locale, ProjectsCopy>> = {
  ...
  pt: {seoTitle:"Projetos internacionais WONLY — Referências governamentais e institucionais",seoDescription:"Portas, fechaduras e janelas WONLY são especificadas em mais de 60 países, desde capitais e instituições até aeroportos, estádios e residências emblemáticas.",eye:"Projetos emblemáticos mundiais",titleA:"Confiança onde",titleB:"errar não é uma opção",intro:"Desde distritos de capitais soberanas até instituições nacionais, WONLY é especificado em mais de 60 países onde segurança, fogo e fiabilidade são essenciais.",discuss:"Vamos conversar sobre seu projeto",stats:["Países e regiões","Projetos internacionais","No exterior desde","Usuários protegidos"],selected:"Referências selecionadas",specified:"Especificado em mais de 60 países",projects:[{name:"CBD da nova capital administrativa",place:"Cairo, Egito",tag:"Governo"},{name:"Centro Nacional de Alimentos",place:"Barbados",tag:"Governo"},{name:"Arco emblemático da nova capital",place:"Cairo, Egito",tag:"Emblemático"},{name:"Cidade Industrial de Jazan",place:"Arábia Saudita",tag:"Industrial"},{name:"Complexo de uso misto",place:"Moçambique · 35.000 m²",tag:"Comercial"},{name:"Centro de Convenções e Exposições",place:"Ásia-Pacífico",tag:"Comercial"},{name:"Aeroporto internacional",place:"Centro aeronáutico",tag:"Infraestrutura"},{name:"Centro esportivo olímpico",place:"Estádio e arena",tag:"Público"},{name:"Residencial metropolitano",place:"Comunidade inteligente",tag:"Residencial"}],references:"Outras referências incluem Abyssinia Bank em Etiópia e palácios presidenciais em Togo e Vanuatu, além de instalações no Oriente Médio, Ásia, África e América.",where:"Onde fornecemos",types:"Para cada tipo de projeto",sectors:[["Governo e instituições","Capitais, ministérios, bancos e instituições onde o cumprimento é obrigatório."],["Hospitalidade e edifícios emblemáticos","Hotéis, estádios, aeroportos e torres que exigem design e desempenho."],["Empreendimentos residenciais","Vilas, condomínios e edifícios com segurança inteligente integrada."],["Industrial e público","Cidades industriais, hospitais e instalações projetadas para fogo, acesso e durabilidade."]],ctaTitle:"Tem um projeto em mente?",ctaSub:"Indique território ou requisitos; respondemos em 24 horas com referências, conformidade e preços."}
};
