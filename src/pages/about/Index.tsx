...
const COPY:Partial<Record<Locale,AboutCopy>>={
 ...
 pt: {text:{seoTitle:"Sobre WONLY | Líder em portas de segurança e fechaduras inteligentes",seoDescription:"WONLY, listada em Xangai 605268: fundada em 1996, cinco bases, seis centros de P&D, mais de 1.000 patentes e 200 milhões de usuários em 60+ países.",about:"Sobre WONLY",heroA:"Protegemos as entradas",heroB:"do mundo",heroSub:"Durante 30 anos temos feito com que abrir uma porta seja seguro, simples e inteligente.",who:"Quem somos",numberOne:"N.º 1 da China em segurança de entrada",heritage1:"WONLY é um grupo tecnológico que integra P&D, design, fabricação, vendas e serviço. Fundada em 1996 em Yongkang, é a única empresa do setor listada no mercado principal chinês (SSE: 605268) e primeira em valor de marca durante 14 anos.",heritage2:"Esta especialização protege mais de 200 milhões de usuários e 50 milhões de famílias, além de bancos, hospitais e projetos emblemáticos em quatro continentes.",mission:"Missão",missionText:"Permitir que famílias de todo o mundo desfrutem uma vida segura, inteligente e melhor.",vision:"Visão",visionText:"Ser líder do ecossistema mundial de segurança inteligente.",ecosystem:"Um ecossistema · Sete categorias",rdEye:"P&D e fabricação inteligente",rdTitle:"Patentes sem rival",rdBody:"A segurança confiável deve ser projetada e demonstrada. WONLY controla toda a cadeia, desde fundir alumínio até programar a fechadura, com mais patentes que os dez principais concorrentes juntos.",milestones:"Marcas",thirty:"Trinta anos, uma direção",global:"Presença mundial",projects:"Escolhida para projetos onde falhar não é uma opção",overseas:"No exterior desde 2010 · Mais de 600 projetos",globalBody:"Em mais de 60 países da África, Oriente Médio, Ásia e América, WONLY equipa palácios presidenciais, bancos, cúpulas e aeroportos internacionais.",references:"As referências incluem a nova capital administrativa do Egito, Abyssinia Bank e palácios presidenciais na Togo e Vanuatu.",qualifications:"Classificações, certificações e reconhecimentos",honorsTitle:"16 reconhecimentos nacionais. Mais de 1.000 prêmios",honorsBody:"Se não somos os únicos, somos os primeiros: desde os maiores prêmios de design até referências nacionais de qualidade.",core:"Valores fundamentais",stand:"O que defendemos",cta:"Associe-se com WONLY",ctaSub:"Distribuição, projeto ou OEM/ODM: indique seu território e responderemos em 24 horas."},stats:["Desde 1996","Usuários protegidos","Famílias atendidas","Valor da marca · 14 anos"],ecosystem:[{name:"Portas de segurança",d:"Portas robotizadas e de alumínio fundido contra intrusão conforme normas de fogo e acústica."},{name:"Fechaduras inteligentes",d:"Detecção real, reconhecimento facial e aplicativo para entrada moderna."},{name:"Portas de madeira e médicas",d:"Portas silenciosas anti-deformação e portas médicas herméticas."},{name:"Janelas e casa inteligente",d:"Janelas inteligentes e ecossistema doméstico de 28 categorias."}],rd:[{t:"5 bases de P&D · 6 centros",d:"Mais de 400 engenheiros, investimento anual superior a ¥80M e laboratório com a Universidade de Pequim."},{t:"Mais de 1.000 patentes",d:"Mais de 300 patentes de invenção e participação em cerca de 100 normas."},{t:"Fábrica do futuro 5G nacional",d:"Única fábrica inteligente do setor reconhecida pelo Estado, com precisão de acabamento automotivo."},{t:"Cinco bases de fabricação",d:"Yongkang, Wuyi, Sichuan, Hangzhou e Hubei produzem milhões de portas e fechaduras."}],story:["WONLY foi fundada em Yongkang com foco único na segurança de entrada.","Ganha o desafio ao campeão de gazua; suas fechaduras não se abrem há mais de 20 anos.","Marca reconhecida da China com reconhecimento comercial e judicial duplo.","Listada na Bolsa de Valores de Xangai 605268 como única empresa do setor no mercado principal.","Abre a única fábrica do futuro 5G nacional do setor.","Lança a expansão global e a estratégia de internacionalização."],landmarks:[{name:"Sede da Cúpula G20",place:"Hangzhou, China"},{name:"Jogos Asiáticos de Hangzhou",place:"Hangzhou, China"},{name:"Aeroporto Beijing-Daxing",place:"Pequim, China"},{name:"Nova capital administrativa",place:"Cairo, Egito"},{name:"Vila dos Jogos Nacionais",place:"Tianjin, China"},{name:"Residências dos ministérios centrais",place:"Pequim, China"}],honors:["Red Dot Best of the Best","Prêmio iF Product Design","Marca líder em design Forbes","Marca reconhecida da China com certificação dupla","Empresa nacional de referência em qualidade","Fornecedor preferencial TOP500 durante 12 anos"],values:[{t:"Integridade e gratidão",d:"Cumprimos nossa palavra com clientes e parceiros e lembramos sua confiança."},{t:"Humildade e respeito",d:"Respeitamos o ofício, as normas e a responsabilidade de proteger casas."},{t:"Diligência e responsabilidade",d:"Impulsionamos a qualidade e respondemos por cada resultado, da fábrica à porta."},{t:"Cooperação benéfica",d:"Crescemos fazendo com que nossos parceiros tenham sucesso rentável, protegido e duradouro."}]}
};
