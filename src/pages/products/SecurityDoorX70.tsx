...
const X70_TOP: Partial<Record<Locale, Record<string, string>>> = {
  ...
  pt: { seoTitle:"Porta de segurança robótica X70 de alumínio fundido para vilas | WONLY",seoDescription:"Porta robótica WONLY X70: reconhecimento facial 3D, fechamento autónomo de 16 parafusos, resistência ao fogo EN 1634 de 90 minutos e proteção classe A.",home:"Início",doors:"Portas de segurança",pioneer:"Pioneira da",robotic:"porta de segurança robótica",hero:"Portas de alumínio fundido que se abrem ao aproximar-se: 30 anos de segurança reinventados.",quote:"Solicitar cotação",range:"Explorar a gama",smart:"Tecnologia inteligente",six:"Seis sistemas.",one:"Uma porta inteligente",auto:"Abertura e fechamento automáticos",pinch:"Sistema antipinzamento inteligente",power:"Alimentação dupla",good:"Bom",air:"Monitor de formaldeído",perimeter:"Vigilância inteligente do perímetro",voice:"Mensagem de voz inteligente",bolts:"Pinos de fechamento",fire:"Resistência ao fogo",acoustic:"Acústica",cycle:"Teste de ciclos" },
};
...
const X70_BODY: Partial<Record<Locale, X70BodyCopy>> = {
  ...
  pt: {
    text:{overview:"Descrição",overviewTitle:"Segurança autônoma que responde a você",overviewBody:"A X70 é a porta de segurança robótica emblemáticas da WONLY. Ao fechar, dezesseis parafusos endurecidos são inseridos mecânicamente nos quatro lados: fechar é bloquear. O reconhecimento facial 3D recebe a família sem mãos e os sensores multivetor vigilam qualquer tentativa de força. O corpo de alumínio fundido integra um núcleo corta-fogo EN 1634, testado durante 200.000 ciclos e respaldado por 30 anos de engenharia.",solutions:"Soluções e cotação",download:"Baixar ficha técnica",standard:"Cilindro padrão",wonlyCore:"Núcleo cilíndrico WONLY",anti:"Resistência a abertura técnica frente ao grau nacional superior",coreEyebrow:"O núcleo reinventado",coreTitle:"Um núcleo cilíndrico, não o cilindro convencional dos demais",coreBody:"Quase todas as portas de segurança utilizam o mesmo cilindro convencional em forma de oito, com carcaça de latão mole e bocadeira exposta. A WONLY o substituiu por um núcleo cilíndrico patenteado, único no setor, projetado para superar amplamente a norma nacional mais alta e resistir à perfuração.",specs:"Especificações",specTitle:"Cada parâmetro, documentado",specBody:"A X70 atende ou supera normas internacionais de segurança, fogo e acústica. Há tamanhos, acabamentos e arranjos personalizados para projetos.",hurricane:"Resistente a tempestades",ready:"Preparada para casa inteligente",request:"Solicitar ficha completa",configurations:"Configurações",choose:"Escolha sua X70",configBody:"Três configurações compartilham o núcleo robótico, com opções de veia da palma ou entrada de villa de duas folhas.",enquire:"Consultar",application:"Aplicações",belongs:"Onde a X70 se encaixa",ctaEye:"Incorpore a X70 ao seu projeto",ctaTitle:"Especificações X70 e preços do projeto",ctaSub:"Nossa equipe técnica responde em 24 horas com especificações, conformidade e preços por volume para distribuidores e promotores."},
    overviewPoints:["Rosto 3D até 1,5 m com proteção contra falsificação em menos de um segundo","Fechamento mecânico automático de 16 parafusos em cada fechadura, sem motor","Núcleo cilíndrico patentado contra perfuração, gazua e bumping","Tela HD de 10,1 polegadas e limiar acessível com selo automático","Integridade ao fogo EN 1634 de 90 minutos e segurança classe A","Controle integral da casa inteligente e alertas de acesso e sabotagem"],
    corePoints:["Núcleo cilíndrico patentado e exclusivo do setor","Resistência a abertura técnica até 36 vezes superior ao grau nacional máximo","Construção endurecida contra perfuração, gazua e bumping","Relatórios de entrada forçada e abertura técnica disponíveis"],
    specLabels:["Modelo","Grau de segurança","Resistência ao fogo","Corpo da porta","Pontos de fechamento","Métodos de abertura","Núcleo da fechadura","Tela inteligente","Câmera da porta","Espessura","Classificação acústica","Resistência ao vento","Conectividade","Alimentação","Teste de ciclos","Garantia","Certificações"],
    variants:[{tag:"Marca",d:"Porta robótica central com rosto 3D, fechamento automático de 16 parafusos e integração total da casa inteligente."},{tag:"Avançada",d:"Adicione veia da palma, tela HD de mira e rede redundante para residências de alta segurança."},{tag:"Villa",d:"Entrada de duas folhas em alumínio fundido, detecção ampliada e acabamentos personalizados para vilas."}],
    scenarios:[{t:"Vilas executivas",d:"Grandes entradas com estética de condomínio, máxima segurança civil e controle inteligente integral."},{t:"Apartamentos de luxo",d:"Acesso familiar sem mãos, abertura remota para convidados e alertas de sabotagem."},{t:"Escritórios executivos",d:"Registros auditáveis, fechamento programado e integração empresarial."}]
  }
};
