...
const PRODUCTS: Record<ProductKey, ProductData> = {
  "s80-max": {
    ...
    hero: `${BASE}images/catalog-2026/hero-renders/s80-max.webp`,
  ...
  "x50-pro": {
    ...
    hero: `${BASE}images/catalog-2026/hero-renders/x50-pro.webp`,
  ...
  t200: {
    ...
    hero: `${BASE}images/catalog-2026/hero-renders/t200.webp`,
