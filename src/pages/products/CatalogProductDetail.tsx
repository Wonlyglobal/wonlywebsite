...
const PRODUCTS: Record<ProductKey, ProductData> = {
  ...
  t200: {
    ...
    gallery: [
      { image: `${BASE}images/catalog-2026/details/t200-auto-open.jpg`, alt: "T200 security door opening automatically for a resident", title: "Smart Auto-Open", text: "The opener activates only after the lock is fully retracted, so powered entry stays synchronized instead of forcing the mechanism." },
      { image: `${BASE}images/catalog-2026/details/t200-clearance.jpg`, alt: "T200 handle with 80 millimetres of anti-pinch clearance", title: "80 mm Pinch-Free Clearance", text: "Extra space between the handle and frame helps keep both left and right hands clear while closing the door." },
      { image: `${BASE}images/catalog-2026/details/t200-threshold.jpg`, alt: "T200 threshold-free automatic bottom seal", title: "Threshold-Free Automatic Seal", text: "The seal retracts when opening and drops when closing, keeping the passage flat for children, older users and pushchairs." },
      { image: `${BASE}images/catalog-2026/details/t200-display.jpg`, alt: "T200 large indoor display and connected entrance information", title: "10.1-Inch HD Display", text: "A large indoor screen presents entrance status, door-viewer information and connected functions in one accessible interface." },
      { image: `${BASE}images/catalog-2026/details/t200-air-quality.jpg`, alt: "T200 air-quality monitoring connected to a mobile phone", title: "Air-Quality Sentry", text: "The entrance system can track temperature, humidity, PM2.5 and formaldehyde, then alert the user when readings move out of range." },
      { image: `${BASE}images/catalog-2026/details/t200-privacy.jpg`, alt: "T200 privacy-masked monitoring field around the entrance", title: "Privacy-Masked Monitoring", text: "The camera keeps the user's doorway visible while masking unrelated neighboring areas and supporting parcel monitoring." },
      { image: `${BASE}images/catalog-2026/details/t200-core.jpg`, alt: "Exploded view of the T200 patented cylindrical lock core", title: "Class C Cylindrical Lock Core", text: "The patented cylindrical platform is presented with 360-minute resistance to manipulation for a stronger mechanical security layer." },
      { image: `${BASE}images/catalog-2026/details/t200-lock-body.jpg`, alt: "T200 patented high-security mechanical lock body", title: "Patented High-Security Lock Body", text: "WONLY's mechanical lock-body platform combines protected engineering with two-way anti-prise hooks." },
      { image: `${BASE}images/catalog-2026/details/t200-dual-power.jpg`, alt: "T200 indoor panel with built-in backup battery", title: "Dual-Power Protection", text: "A 220 V mains supply and built-in battery backup help keep essential door functions available during a power interruption." },
    ],
    specs: [
