...
const data: ProductPageData = {
  ...
  series: [
    ...
    { name: "P15 Pro Slim Biometric Smart Lock", tag: "Slim Pro", d: "A slim-profile face or palm-vein model for modern entrance doors.", img: `${BASE}images/catalog-2026/models/p15-pro.webp`, path: "/products/smart-locks/p15-pro" },
    ...
    { name: "A5N Retail Smart Lock", tag: "Essential", d: "A practical semi-automatic fingerprint smart lock for distribution programmes.", img: `${BASE}images/catalog-2026/models/a5n.webp`, path: "/products/smart-locks/a5n" },
  ],
