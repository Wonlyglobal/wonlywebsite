 ...
 */
export default function ProductComingSoon({ name }: { name: string }) {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center text-center px-6" style={{ background: "#0d0d0d" }}>
      <div className="text-[11px] tracking-[0.4em] uppercase font-light" style={{ color: "#BFA06A" }}>WONLY Products</div>
