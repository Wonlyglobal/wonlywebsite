...
const TEXT: Partial<Record<Locale, Record<string, string>>> = {
  ...
  pt: {
    "Global Strategy":"Estratégia global","A New Era,":"Uma nova era,","Going Global":"para o mundo","2026 marks WONLY's 30th anniversary — and the launch of our global development strategy, taking premium smart-security from Yongkang, Zhejiang to distributors and projects worldwide.":"Em 2026, o WONLY comemora 30 anos e lança sua estratégia global para levar a segurança inteligente premium de Yongkang a distribuidores e projetos ao redor do mundo.","Global Footprint":"Presença global","We Spread":"Estamos presentes","Around the World":"em todo o mundo","From Yongkang, Zhejiang to 60+ countries and regions — backed by five manufacturing bases and six R&D centers.":"Desde Yongkang, Zhejiang, até mais de 60 países e regiões, com cinco bases de produção e seis centros de P&D.","Countries & Regions":"Países e regiões","Production Bases":"Bases de produção","R&D Centers":"Centros de P&D","Users Protected":"Usuários protegidos","Going-Global Roadmap":"Rota global","Core to":"De mercados-chave ao","Worldwide":"mundo inteiro","Core Markets":"Mercados principais","Middle East, Southeast Asia and Central Asia — our strategic entry regions, with certified products tuned to local climate and standards.":"Oriente Médio, Sudeste Asiático e Ásia Central são regiões estratégicas de entrada, com produtos certificados para o clima e as normas locais.","Expanding Reach":"Expansão do alcance","Radiating to Africa, Latin America and Oceania through distributor networks and landmark project references.":"Expansão para África, América Latina e Oceania por meio de redes de distribuidores e projetos emblemáticos.","Localized Ecosystem":"Ecossistema localizado","Regional HQs, authorized partners and local service teams bring the whole-building security ecosystem to every market.":"Sedes regionais, parceiros autorizados e equipes locais levam o ecosistema integral de segurança para cada mercado.","Global Landmark Projects":"Projetos emblemáticos globais","Trusted":"Confiança","Across Borders":"sem fronteiras","Egypt":"Egito","Saudi Arabia":"Arábia Saudita","Barbados":"Barbados","Mozambique":"Moçambique","New Administrative Capital CBD":"CBD da nova capital administrativa","Jizan Industrial City Villas":"Vilas da cidade industrial de Jizan","National Grain Centre":"Centro nacional de cereais","Mixed-Use Complex":"Complexo de uso misto","Our Vision":"Nossa visão","To Become the":"Tornar-nos o","Global Smart-Security Ecosystem Leader":"líder mundial do ecosistema de segurança inteligente","Grow With WONLY":"Cresça com WONLY","Bring WONLY to Your Market":"Leve WONLY para seu mercado","Distributors and project partners — tell us your territory and our team replies within 24 hours.":"Distribuidores e parceiros de projetos: indique seu território e responderemos em 24 horas."
  }
};
