...
const COPY:Partial<Record<Locale,ManufacturingCopy>>={
 ...
 pt: {seoTitle:"Fabricação e P&D | WONLY",seoDescription:"WONLY: mais de um milhão de m² de fábricas integradas, linhas robotizadas ABB, cinco bases, seis centros de P&D e mais de 1.000 patentes.",eye:"Fabricação e P&D",titleA:"Engenharia em grande escala.",titleB:"Construído para durar",intro:"Trinta anos de fabricação integrada em Yongkang: mais de um milhão de m² de fábricas inteligentes, linhas robotizadas e seis centros de P&D.",stats:["Superfície industrial","Bases de produção","Centros de P&D","Patentes","Portas / fechaduras por ano"],story:[{eb:"Integração vertical",h:"Tudo sob o mesmo controle",p:"Estampação, revestimento, espuma e montagem são realizados em cinco bases próprias para controlar qualidade, uniformidade e prazos.",li:["Estampação, espuma PU, pintura em pó e montagem internas","Cinco bases integradas na China","6 milhões de portas e 3 milhões de fechaduras por ano"]},{eb:"Precisão robotizada",h:"Automatização para projetos internacionais",p:"As células de soldadura ABB e a manipulação robotizada mantêm as tolerâncias exigidas por projetos internacionais.",li:["Soldadura automatizada ABB e manipulação robotizada","Mecanizado CNC com tolerâncias repetíveis","Supervisão de fábrica inteligente conectada por 5G"]},{eb:"Qualidade e testes",h:"Testes além da norma",p:"Cada linha é validada segundo normas internacionais de segurança, fogo e durabilidade antes do envio, com mais de 200.000 ciclos.",li:["Mais de 200.000 ciclos de durabilidade","Validação de fogo, segurança e acústica","Processos certificados ISO 9001, CE e UL"]}],rdEye:"Pesquisa e desenvolvimento",rdA:"Seis centros,",rdB:"mil patentes",rd:[{t:"Centros de P&D",d:"Seis centros impulsionam portas, fechaduras e sistemas integrais de casa inteligente."},{t:"Patentes",d:"Mais de mil patentes de segurança estrutural, biometria e integração IoT"},{t:"Grupo cotizado",d:"Primeira empresa do setor no mercado principal de Xangai desde 2021, respaldo de cada garantia."}],ctaEye:"Associação OEM / ODM",ctaTitle:"Construa sua marca sobre nossas fábricas",ctaSub:"Aproveite nossas fábricas e mais de 1.000 patentes para uma linha desenvolvida e fabricada pela WONLY."}
};
