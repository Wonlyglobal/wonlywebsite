...
const COPY:Partial<Record<Locale,AdvantageCopy>>={
 ...
 pt: {seoTitle:"Vantagens das portas de segurança e fechaduras inteligentes | WONLY",seoDescription:"Por que WONLY: portas corta-fogo de alumínio fundido, fechaduras biométricas e mais de 1.000 patentes, com ISO, CE, UL, SASO e prêmios Red Dot e iF.",eye:"Vantagens",titleA:"Desenhado para",titleB:"superar",intro:"Cada porta e fechadura WONLY supera normas internacionais de segurança, fogo e durabilidade, respaldada por certificados, testes e prêmios.",door:{...DOOR,eb:"Por que uma porta WONLY",h:"O corpo criado para defender",p:"A porta é uma fortaleza: alumínio fundido sobre núcleo de aço celular, desenhada contra fogo, força e clima conforme a normas internacionais.",li:["Alumínio fundido e núcleo de aço que não se oxida nem se deforma","Integridade ao fogo EN 1634 de 90 minutos","Classe A e fechamento de 16 parafusos em quatro lados","Vento classe 12, acústica STC 35+ e 200.000 ciclos"]},genEye:"Gerações de portas inteligentes",genTitle:"Por que a classe A não conta tudo",genBody:"Após a atualização da norma, muitas portas classificam como grau máximo no papel, embora as diferenças sejam enormes. WONLY adiciona gerações de inteligência sobre o mesmo núcleo classe A.",gens:[{g:"Gen. 1",t:"Base",d:"Segurança classe A e fechamento mecânico automático para um nível confiável."},{g:"Gen. 2–3",t:"Inteligente",d:"Fechadura integrada, biometria, tela HD, controle de formaldeído e alimentação dupla."},{g:"Gen. 5",t:"Robótica — X70",d:"Abertura automática, detecção remota, anti-pinça, perímetro e mensagens de voz."}],genNote:"Conte-nos seu mercado e ajudaremos a criar uma linha multigeneracional, sempre certificada e diferenciada por inteligência.",lock:{...LOCK,eb:"Por que uma fechadura WONLY",h:"O cérebro que o reconhece",p:"A fechadura reconhece a família e abre ao aproximar-se; seu núcleo patentado e eletrônica cifrada protegem contra ataques físicos e digitais.",li:["Rosto 3D, impressão digital, veia da palma, RFID, aplicativo, PIN e abertura por aproximação","Núcleo cilíndrico patentado contra perfuração, gazua e bumping","Aplicativo cifrado com alarmas de chave e sabotagem","Integração com casa inteligente WONLY"]},innovation:"Inovação e certificações",recognised:"Reconhecida.",certified:"Certificada. Premiada.",proof:"Mais de 1.000 patentes, prêmios internacionais e certificações para projetos globais.",awards:"Prêmios de design",certs:"Certificações",ctaEye:"Veja a diferença",ctaTitle:"Solicite especificações, conformidade e testes",ctaSub:"Nossa equipe compartilha certificados e especificações completos em 24 horas."}
};
