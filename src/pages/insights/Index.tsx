...
const UI:Partial<Record<Locale,Record<string,string>>>={
 ...
 pt:{seoTitle:"Notícias e insights — Portas de segurança e fechaduras inteligentes | WONLY",seoDescription:"Guias práticos, tecnologia e análises de mercado para distribuidores e compradores de portas e fechaduras inteligentes.",eye:"Notícias e insights",titleA:"Guias, tecnologia e",titleB:"análises de mercado",intro:"Conhecimento prático para distribuidores, compradores de projetos e parceiros, da seleção às perspectivas do mercado.",All:"Todos","Buying Guide":"Guia de compra",Technology:"Tecnologia","Market Insight":"Análise de mercado",Company:"Empresa",min:"min de leitura",read:"Ler artigo"}
};
