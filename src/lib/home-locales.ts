...
const SECTION_TEXT: Partial<Record<Locale, Record<string, string>>> = {
  ar: {
    "Manufacturing Base": "قاعدة التصنيع", "Annual Production Capacity": "الطاقة الإنتاجية السنوية", Scroll: "مرّر", Skip: "تخطي", Door: "الأبواب", "Smart Lock": "الأقفال الذكية", "Smart Window": "النوافذ الذكية", "Whole-House Intelligence": "ذكاء المنزل بالكامل", "30 Years": "30 عاماً", "Since 1996 · Yongkang": "منذ 1996 · يونغكانغ", Listed: "مدرجة", "Production Bases": "قواعد الإنتاج", Patents: "براءات اختراع", "Users Protected": "مستخدمون محميون", "Thank you — your request has been received.": "شكراً لك — تم استلام طلبك.", "Our team will reply within 24 hours with tailored specifications, compliance documentation and pricing.": "سيرد فريقنا خلال 24 ساعة بمواصفات ووثائق امتثال وأسعار مخصصة.",
  ...
  fr: {
    "Manufacturing Base": "Surface industrielle", "Annual Production Capacity": "Capacité annuelle de production", Scroll: "Défiler", Skip: "Passer", Door: "Portes", "Smart Lock": "Serrures intelligentes", "Smart Window": "Fenêtres intelligentes", "Whole-House Intelligence": "Intelligence de toute la maison", "30 Years": "30 ans", "Since 1996 · Yongkang": "Depuis 1996 · Yongkang", Listed: "Coté en bourse", "Production Bases": "Bases de production", Patents: "Brevets", "Users Protected": "Utilisateurs protégés", "Thank you — your request has been received.": "Merci — votre demande a bien été reçue.", "Our team will reply within 24 hours with tailored specifications, compliance documentation and pricing.": "Notre équipe répondra sous 24 heures avec des spécifications, documents de conformité et tarifs adaptés.",
  ...
  ru: {
    "Manufacturing Base": "Производственная площадь", "Annual Production Capacity": "Годовая производственная мощность", Scroll: "Прокрутить", Skip: "Пропустить", Door: "Двери", "Smart Lock": "Умные замки", "Smart Window": "Умные окна", "Whole-House Intelligence": "Умный дом", "30 Years": "30 лет", "Since 1996 · Yongkang": "С 1996 года · Юнкан", Listed: "Публичная компания", "Production Bases": "Производственные базы", Patents: "Патенты", "Users Protected": "Защищённые пользователи", "Thank you — your request has been received.": "Спасибо — ваш запрос получен.", "Our team will reply within 24 hours with tailored specifications, compliance documentation and pricing.": "Наша команда ответит в течение 24 часов и предоставит спецификации, документы о соответствии и цены.",
  ...
  es: {
    "Manufacturing Base": "Superficie industrial", "Annual Production Capacity": "Capacidad anual de producción", Scroll: "Desplazar", Skip: "Omitir", Door: "Puertas", "Smart Lock": "Cerraduras inteligentes", "Smart Window": "Ventanas inteligentes", "Whole-House Intelligence": "Inteligencia integral del hogar", "30 Years": "30 años", "Since 1996 · Yongkang": "Desde 1996 · Yongkang", Listed: "Empresa cotizada", "Production Bases": "Bases de producción", Patents: "Patentes", "Users Protected": "Usuarios protegidos", "Thank you — your request has been received.": "Gracias — hemos recibido su solicitud.", "Our team will reply within 24 hours with tailored specifications, compliance documentation and pricing.": "Nuestro equipo responderá en 24 horas con especificaciones, documentación de conformidad y precios adaptados.",
...
type StatCardCopy = { value: string; label: string; description: string };
const STAT_CARD_COPY: Partial<Record<Locale, StatCardCopy[]>> = {
  ar: [
    {value:"30 عاماً",label:"منذ 1996 · يونغكانغ",description:"ثلاثة عقود من التصنيع المتكامل والمتواصل منذ تأسيسنا في يونغكانغ، تشجيانغ."},{value:"مدرجة",label:"بورصة شنغهاي 605268",description:"أول شركة مدرجة في القطاع في بورصة شنغهاي منذ عام 2021."},{value:"رقم 1",label:"الأبواب والأقفال الذكية · 2024–2025",description:"متصدر المبيعات الوطنية للأبواب والأقفال الذكية لعامين متتاليين."},{value:"5",label:"قواعد إنتاج",description:"خمس قواعد إنتاج متكاملة رأسياً في الصين."},{value:"6",label:"مراكز بحث وتطوير",description:"ستة مراكز تدفع الابتكار المستمر في المنتجات."},{value:"+1,000",label:"براءة اختراع",description:"أكثر من ألف براءة اختراع في الأمن والأقفال الذكية."},{value:"+200M",label:"مستخدم محمي",description:"حماية أكثر من 200 مليون مستخدم حول العالم."}
  ],
  fr: [
    {value:"30 ans",label:"Depuis 1996 · Yongkang",description:"Trois décennies de fabrication continue et verticalement intégrée depuis notre création à Yongkang, Zhejiang."},{value:"Coté",label:"Bourse de Shanghai 605268",description:"Première entreprise cotée du secteur à la Bourse de Shanghai depuis 2021."},{value:"N° 1",label:"Portes et serrures intelligentes · 2024–2025",description:"Leader national des ventes de portes et serrures intelligentes deux années de suite."},{value:"5",label:"Bases de production",description:"Cinq bases de production verticalement intégrées en Chine."},{value:"6",label:"Centres de R&D",description:"Six centres assurent l’innovation continue des produits."},{value:"1 000+",label:"Brevets",description:"Plus de 1 000 brevets propriétaires en sécurité et serrures intelligentes."},{value:"200 M+",label:"Utilisateurs protégés",description:"Plus de 200 millions d’utilisateurs protégés dans le monde."}
  ],
  ru: [
    {value:"30 лет",label:"С 1996 года · Юнкан",description:"Три десятилетия непрерывного вертикально интегрированного производства с момента основания в Юнкане."},{value:"Листинг",label:"Шанхайская биржа 605268",description:"Первая публичная компания отрасли на Шанхайской бирже с 2021 года."},{value:"№ 1",label:"Умные двери и замки · 2024–2025",description:"Лидер национальных продаж умных дверей и замков два года подряд."},{value:"5",label:"Производственные базы",description:"Пять вертикально интегрированных производственных баз в Китае."},{value:"6",label:"Центры НИОКР",description:"Шесть центров обеспечивают непрерывные инновации продукции."},{value:"1 000+",label:"Патенты",description:"Более тысячи собственных патентов в области безопасности и умных замков."},{value:"200 млн+",label:"Защищённые пользователи",description:"Защита более 200 миллионов пользователей по всему миру."}
  ],
  es: [
...
export function homeStatCard(locale: Locale, index: number, fallback: StatCardCopy): StatCardCopy {
  return STAT_CARD_COPY[locale]?.[index] ?? fallback;
}
